-- SQLite 3 seed data for the DB Tool dev environment.
-- Applied by the APP at runtime (after schema.sql) — NOT by Docker.
-- Mirrors the PostgreSQL and MySQL seeds as closely as SQLite allows:
--   * booleans -> INTEGER 0/1
--   * JSON (tags array, metadata object) -> TEXT holding JSON strings
